...
#pragma DATA_SECTION (shared_edma_obj, ".msmc_data")
EDMA_OBJ_T shared_edma_obj[NO_CHANNELS_PER_CORE * NO_GEMM_CORES];

// EDMA NO, START_CH_NO, QUE_NO, START_PARAM_NO, START_INTR_NO/TCC_TAG
const uint8_t edma_channel_mappings[NO_GEMM_CORES][5] = {
		{0, 1, 1, 1, 1},
		{1, 0, 0, 0, 3},
		{1, 3, 1, 16, 6},
		{1, 6, 2, 32, 9},
...
void all_edma_init() {
	...
	for(core = 0; core < NO_GEMM_CORES; core++) {
